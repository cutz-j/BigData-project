...
all_data['income_cluster'] = 0
income_cluster(all_data['predK25'])
all_data['center_cluster1'] = 0
center_cluster(all_data, 'center_access', 'center_cluster1')
all_data['people_cluster1'] = 0
people_cluster('people_access', 'people_cluster1')
all_data['center_cluster2'] = 0
center_cluster(all_data, 'center_access_2', 'center_cluster2')
all_data['people_cluster2'] = 0
people_cluster('people_access_2', 'people_cluster2')
...
all_data.to_csv("d:/project_data/all_data.csv", encoding='cp949')
